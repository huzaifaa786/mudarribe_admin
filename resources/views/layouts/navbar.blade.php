<main class="ease-soft-in-out xl:ml-68.5 relative h-full max-h-screen rounded-xl transition-all duration-200 first-line:">
    <!-- Navbar -->
    <nav style="background-color: #FDFEFE" class=" shadow-xl relative flex flex-wrap items-center justify-between px-0 py-4 mx-6 transition-all duration-250 ease-soft-in rounded-2xl lg:flex-nowrap lg:justify-start mt-5"
