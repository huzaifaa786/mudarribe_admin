                ...
                <ul class="pb-2 pt-1">
                    ...
                    <li>
                        ...
                        <ul id="dropdown-users" sidebar-toggle-list="" class="pb-2 pt-1 hidden">
                            <li>
                                <a href="https://demos.creative-tim.com/soft-ui-flowbite-pro/users/list/"
                                    class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span>Users
                                        list</span><span class="hidden">U</span></a>
                            </li>
                            <li>
                                <a href="https://demos.creative-tim.com/soft-ui-flowbite-pro/users/profile/"
                                    class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span>Profile</span><span
                                        class="hidden">P</span></a>
                            </li>
                            <li>
                                <a href="https://demos.creative-tim.com/soft-ui-flowbite-pro/users/settings/"
                                    class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span>Settings</span><span
                                        class="hidden">S</span></a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <button type="button"
                            class="w-full flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-gray-200 group transition-all duration-200"
                            sidebar-toggle-collapse="" aria-controls="dropdown-pages"
                            ...
                            <div
                                ...
                                <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1"
                                    ...
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <g transform="translate(-1720.000000, -592.000000)" fill="currentColor"
                                            fill-rule="nonzero">
                                            <g transform="translate(1716.000000, 291.000000)">
                            ...
                            <span class="ml-3 text-dark-500 text-sm font-light" sidebar-toggle-item="">Pages</span>
                            <svg sidebar-toggle-item="" class="w-4 h-4 ml-auto text-gray-700" fill="currentColor"
                                viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                        ...
                        <ul id="dropdown-pages" sidebar-toggle-list="" class="pb-2 pt-1 hidden">
                            <li>
                                <a href="https://demos.creative-tim.com/soft-ui-flowbite-pro/pages/pricing/"
                                    class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span>Pricing</span><span
                                        class="hidden">P</span></a>
                            </li>
                            <li>
                                <a href="https://demos.creative-tim.com/soft-ui-flowbite-pro/pages/maintenance/"
                                    class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span>Maintenance</span><span
                                        class="hidden">M</span></a>
                            </li>
                            <li>
                                <a href="https://demos.creative-tim.com/soft-ui-flowbite-pro/pages/404/"
                                    class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span>404
                                        not found</span><span class="hidden">4</span></a>
                            </li>
                            <li>
                                <a href="https://demos.creative-tim.com/soft-ui-flowbite-pro/pages/500/"
                                    class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span>500
                                        server error</span><span class="hidden">5</span></a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <button type="button"
                            class="w-full flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-gray-200 group transition-all duration-200"
                            sidebar-toggle-collapse="" aria-controls="dropdown-auth"
                            ...
                            <div
                                ...
                                <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1"
                                    ...
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <g transform="translate(-2020.000000, -442.000000)" fill="currentColor"
                                            fill-rule="nonzero">
                                            <g transform="translate(1716.000000, 291.000000)">
                        ...
                        <ul id="dropdown-auth" sidebar-toggle-list="" class="pb-2 pt-1 hidden">
                            <li>
                                <a href="https://demos.creative-tim.com/soft-ui-flowbite-pro/authentication/sign-in/"
                                    class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span>Sign
                                        in</span><span class="hidden">S</span></a>
                            </li>
                            <li>
                                <a href="https://demos.creative-tim.com/soft-ui-flowbite-pro/authentication/sign-up/"
                                    class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span>Sign
                                        up</span><span class="hidden">S</span></a>
                            </li>
                            <li>
                                <a href="https://demos.creative-tim.com/soft-ui-flowbite-pro/authentication/forgot-password/"
                                    class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span>Forgot
                                        password</span><span class="hidden">F</span></a>
                            </li>
                            <li>
                                <a href="https://demos.creative-tim.com/soft-ui-flowbite-pro/authentication/reset-password/"
                                    class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span>Reset
                                        password</span><span class="hidden">R</span></a>
                            </li>
                            <li>
                                <a href="https://demos.creative-tim.com/soft-ui-flowbite-pro/authentication/profile-lock/"
                                    class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span>Profile
                                        lock</span><span class="hidden">P</span></a>
                            </li>
                        </ul>
                    </li>
                </ul>
