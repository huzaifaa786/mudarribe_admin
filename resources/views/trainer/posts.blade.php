                ...
                <tbody>
                    @foreach ($posts as $post)
                        <tr
                            ...
                            <td scope="row"
                                class="flex items-center p py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                <div class="cursor-zoom-in">
                                    <img src="{{ $post['imageUrl'] }}" width="80" height="80" alt=""
                                        data-modal-target="image-{{ $post['id'] }}"
                                        data-modal-toggle="image-{{ $post['id'] }}">
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                {{ $post['caption'] }}
                        ...
                        <div id="image-{{ $post['id'] }}" tabindex="-1" aria-hidden="true"
                            ...
                            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                ...
                                <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                    ...
                                    <div class="flex justify-center items-center space-x-4">
                                        <button data-modal-toggle="image-{{ $post['id'] }}" type="button"
