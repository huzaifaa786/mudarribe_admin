         ...
         <div class="p-6 pt-0 text-center">
             ...
             <form method="get">
                 ...
                 <button data-modal-toggle="popup-modal" type="submit"
                     class="text-white bg-gradient-to-br from-red-400 to-red-600 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 text-center inline-flex items-center shadow-md shadow-gray-300 hover:scale-[1.02] transition-transform">
                     Yes, I'm sure
                 </button>
