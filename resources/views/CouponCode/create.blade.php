        ...
        <div class="flex justify-center">
            <div class="w-full md:w-1/2">
                <div class="bg-white rounded-lg shadow-lg p-6">
                    <h1 class="text-2xl font-semibold mb-6 text-center">Create Coupon</h1>
