            ...
            <tbody>
                @foreach ($events as $event)
                    <tr
                        ...
                        <td class="px-3 py-4">
                            <img src="{{ $event['event']['imageUrl'] }}" width="40" height="40" alt=""
                                data-modal-target="image-{{ $event['event']['id'] }}"
                                data-modal-toggle="image-{{ $event['event']['id'] }}" class="cursor-zoom-in">
                        </td>
                        <td class=" p py-4 text-gray-900 whitespace-nowrap dark:text-white">
                            <div class="">
                                <div class="text-base font-semibold">{{ $event['event']['title'] }}</div>
                            </div>
                        </td>
                        <td class=" p py-4 text-gray-900 whitespace-nowrap dark:text-white">
                            <div class="">
                                <div class="text-base font-semibold">{{ $event['trainer']['name'] }}</div>
                            </div>
                        </td>
                        {{-- <td class=" p py-4 text-gray-900 whitespace-nowrap dark:text-white">
                            <div class="">
                                <div class="text-base font-semibold">{{ $event['user']['name'] }}</div>
                            </div>
                        </td> --}}
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                @if ($event['event']['eventStatus'] == 'open')
                        ...
                        <td class="px-6 py-4">
                            {{ Carbon\Carbon::createFromTimestampMs($event['event']['date'])->format('d M Y') }}
                        </td>
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                {{ Carbon\Carbon::createFromFormat('d/m/Y', $event['event']['toDate'])->format('d M Y') }}
                            </div>
                        </td>

                        <div id="image-{{ $event['event']['id'] }}" tabindex="-1" aria-hidden="true"
                            ...
                            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                ...
                                <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                    <button type="button"
                                        ...
                                        data-modal-toggle="image-{{ $event['event']['id'] }}">
                                    ...
                                    <img src="{{ $event['event']['imageUrl'] }}" alt=""
                                        class="h-auto w-96 object-contain">
                                    <div class="flex justify-center items-center space-x-4">
                                        <button data-modal-toggle="image-{{ $event['event']['id'] }}" type="button"
